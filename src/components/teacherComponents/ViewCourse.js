...
import { getCourse ,getFile} from "../../services/teacher.service";
        ...
        <main >
          ...
          <div id="crsBox" >
              ...
              <h1 className="fs-title">{ courseState.title }</h1>
                    ...
                    <label   className="courseInfo" style={{marginLeft:'50px'}}>Level : { courseState.level!==undefined?courseState.level:'' }</label>  
